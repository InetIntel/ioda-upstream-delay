            ...
            if line.startswith('t'):
                ...
                if len(ip_add) == int(max_ttl):
                    ...
                    if len(dest_as) == 0:
                        ...
                        pen_as = next((i for i in reversed(asn) if i and i != str(dest_as[0]) and i != "N/A"), None)
                        ...
                        if pen_as_index is not None and dest_as_index is not None:
                            ...
                            latency = float(time[len(asn) - dest_as_index - 1]) - float(time[pen_as_index])
                        else:
